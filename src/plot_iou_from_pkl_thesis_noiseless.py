...
def plot_iou_over_time(test_prefix, make_square=False):
    ...
    for jf in json_files:
        ...
        if method_raw == 'EKF':
            method = 'Explicit EKF'
        elif method_raw == 'IEKF':
            method = 'Explicit IEKF'
        elif method_raw == 'IMPLICIT_EKF':
            method = 'Implicit EKF'
        elif method_raw == 'IMPLICIT_IEKF':
            method = 'Implicit IEKF'
        else:
            method = method_raw
            
        # Differentiate groups by checking for "noiseless" or "zeronoise" in the filename
