...
def run_mc_experiment(experiment_name, methods):
    ...
    for method in methods:
        ...
        for run_file in tqdm(run_files, desc=f"Evaluating {method}"):
            ...
            # Create a distinct config for tracking modifying just the tracking setting
            ...
            if method == "implicit_ekf":
                tracker_cfg_run.max_iterations = 1
                 ...
                 tracker_cfg_run.max_iterations = 20 # from the global defs
                 
            # Custom properties from main
            ...
            tracker_cfg_run.use_L_W_aspect_ratio_prior = False
